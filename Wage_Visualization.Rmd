---
title: "USA Minimum Wage Visualization"
author: "SaiRahul_Gummalla"
date: "3/7/2021"
...
library(ggthemes)
library(MASS)
source('F:/GMU/STAT515/Mid Term Project/hw.R')
library(dplyr)
library(choroplethr)
...
```{r}
wage <- read.csv("F:/GMU/STAT515/Mid Term Project/Minimum Wage Data after data cleaning.csv")
head(wage)
```
```{r}
stateabb <- read.csv("F:/GMU/STAT515/Mid Term Project/stateabb.csv")
head(stateabb)
```
